...
- `netbox` was upgraded from the 3.3 branch to the 3.4 branch. Please make sure to check the breaking changes mentioned in the [3.4.0 release notes](https://github.com/netbox-community/netbox/releases/tag/v3.4.0)
